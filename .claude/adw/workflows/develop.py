"""
Develop workflow - Implements features from Linear issues.

This workflow:
1. Loads workflow state
2. Checks out the correct branch
3. Executes the /develop command with the issue ID
...
def run_develop(state: WorkflowState) -> int:
    ...
    # Step 2: Execute /develop command with issue ID
    log_step(logger, 2, "Fetching requirements and implementing")
